...
import { BookOpen, Check, CircleCheck, Ear, Globe2, GraduationCap, MapPin, MessageCircle, Mic2, NotebookText, Phone, School, Send, Sparkles, Users, Volume2 } from "lucide-react";
...
export function HomePage() {
  ...
  return <LazyMotion features={domAnimation} strict>
    ...
    <main id="main">
      <section className="hero" id="top">
        ...
        <Container className="hero-grid">
          <m.div className="hero-copy" initial={reduced ? false : "hidden"} animate="show" variants={{ hidden: {}, show: { transition: { staggerChildren: .09 } } }}>
            <m.p className="trust-label" variants={reduced ? undefined : { hidden: { opacity: 0, y: 14 }, show: { opacity: 1, y: 0 } }}><span>ა</span> Уроки грузинского с носителем языка</m.p>
            <m.h1 variants={reduced ? undefined : { hidden: { opacity: 0, y: 18 }, show: { opacity: 1, y: 0 } }}>Уроки грузинского в Батуми — <em>говорите увереннее</em></m.h1>
            <m.p className="hero-lead" variants={reduced ? undefined : { hidden: { opacity: 0, y: 18 }, show: { opacity: 1, y: 0 } }}>Спокойно, понятно и без зубрёжки. Индивидуальные, групповые и онлайн-занятия с носителем языка для русскоговорящих детей и взрослых — учимся понимать живую речь и пользоваться грузинским каждый день.</m.p>
            <m.div className="hero-actions" variants={reduced ? undefined : { hidden: { opacity: 0, y: 18 }, show: { opacity: 1, y: 0 } }}><PrimaryLink>Узнать о свободных местах</PrimaryLink><SecondaryLink href={whatsapp}>Написать в WhatsApp</SecondaryLink></m.div>
            <m.ul className="hero-facts" variants={reduced ? undefined : { hidden: { opacity: 0 }, show: { opacity: 1 } }}><li><Users />Для детей и взрослых</li><li><MapPin />Онлайн и в Батуми</li><li><CircleCheck />20 ₾ за занятие</li></m.ul>
          </m.div>
          <m.div className="hero-visual" initial={reduced ? false : { opacity: 0, scale: .96 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: .75, delay: .2, ease: [0.22, 1, 0.36, 1] }}>
            <picture><source srcSet="/images/hero-kristina-640.avif 640w, /images/hero-kristina-960.avif 960w, /images/hero-kristina-1600.avif 1600w" sizes="(max-width: 820px) calc(100vw - 36px), (max-width: 1240px) 46vw, 555px" type="image/avif" /><source srcSet="/images/hero-kristina-640.webp 640w, /images/hero-kristina-960.webp 960w, /images/hero-kristina-1600.webp 1600w" sizes="(max-width: 820px) calc(100vw - 36px), (max-width: 1240px) 46vw, 555px" type="image/webp" /><img src="/images/hero-kristina-960.webp" alt="Кристина Беридзе — преподаватель грузинского языка в Батуми" width="1600" height="1067" fetchPriority="high" decoding="async" /></picture>
      ...
      <section className="studio-section" aria-labelledby="children-lesson-title"><Container><Reveal><div className="studio-image"><picture><source srcSet="/images/children-georgian-lesson-640.avif 640w, /images/children-georgian-lesson-960.avif 960w, /images/children-georgian-lesson-1600.avif 1600w" sizes="(max-width: 1220px) calc(100vw - 36px), 1180px" type="image/avif" /><source srcSet="/images/children-georgian-lesson-640.webp 640w, /images/children-georgian-lesson-960.webp 960w, /images/children-georgian-lesson-1600.webp 1600w" sizes="(max-width: 1220px) calc(100vw - 36px), 1180px" type="image/webp" /><img src="/images/children-georgian-lesson-1600.webp" alt="Двое детей пишут грузинские буквы в тетрадях на уроке в Батуми" width="1600" height="900" loading="lazy" decoding="async" /></picture><div className="studio-caption"><span>Грузинский для детей</span><strong id="children-lesson-title">Слушаем, читаем и пишем — вместе</strong></div></div></Reveal></Container></section>
      ...
      <section className="section contact-section" id="contact"><Container className="contact-grid"><Reveal><div><SectionHeading eyebrow="Связаться" title="Узнайте, есть ли сейчас свободные места" text="Расскажите немного об ученике и удобном формате. Кристина ответит лично и поможет подобрать подходящее время." /><address className="contact-details"><a href="https://wa.me/995571010750" target="_blank" rel="me noreferrer" data-cta="whatsapp"><span className="whatsapp-icon"><FaWhatsapp aria-hidden="true" /></span><div><small>Быстрый ответ в сообщениях</small><strong>Написать в WhatsApp</strong></div></a><a href="tel:+995571010750"><span><Phone aria-hidden="true" /></span><div><small>Телефон</small><strong>+995 571 01 07 50</strong></div></a><a href="mailto:K.beridze1982@gmail.com"><span><Send aria-hidden="true" /></span><div><small>Электронная почта</small><strong>K.beridze1982@gmail.com</strong></div></a><div><span><MapPin aria-hidden="true" /></span><div><small>Очные занятия</small><strong>Батуми, Грузия</strong></div></div></address></div></Reveal><Reveal delay={.1}><ContactForm /></Reveal></Container></section>
    ...
    <footer><Container><div className="footer-grid"><div><a className="wordmark footer-logo" href="#top" aria-label="Кристина Беридзе — на главную"><Image className="brand-logo" src="/kb-logo.png" alt="" width="42" height="42" unoptimized /><strong>Кристина Беридзе</strong></a><p>Уроки грузинского языка<br />Батуми, Грузия</p></div><div><strong>Навигация</strong><a href="#about">Обо мне</a><a href="#formats">Форматы</a><a href="#program">Программа</a><a href="#contact">Контакты</a></div><address className="footer-contacts"><strong>Связаться</strong><a className="social-link whatsapp" href={whatsapp} target="_blank" rel="me noreferrer" data-cta="whatsapp"><span><FaWhatsapp aria-hidden="true" /></span><div><b>WhatsApp</b><small>+995 571 01 07 50</small></div></a><a className="social-link facebook" href="https://www.facebook.com/kristina.beridze.3" target="_blank" rel="me noreferrer"><span><FaFacebookF aria-hidden="true" /></span><div><b>Facebook</b><small>Профиль Кристины</small></div></a><a className="footer-email" href="mailto:K.beridze1982@gmail.com">K.beridze1982@gmail.com</a></address></div><div className="footer-bottom"><span>© {new Date().getFullYear()} Кристина Беридзе</span><span>Данные из формы используются только для ответа на заявку.</span></div></Container></footer>
  </LazyMotion>;
}
