      ...
      <section className="hero" id="top">
        ...
        <Container className="hero-grid">
          ...
          <m.div className="hero-visual" initial={reduced ? false : { opacity: 0, scale: .96 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: .75, delay: .2, ease: [0.22, 1, 0.36, 1] }}>
            <picture><source srcSet="/images/hero-studio-640.avif 640w, /images/hero-studio-960.avif 960w, /images/hero-studio-1600.avif 1600w" sizes="(max-width: 820px) calc(100vw - 36px), (max-width: 1240px) 46vw, 555px" type="image/avif" /><source srcSet="/images/hero-studio-640.webp 640w, /images/hero-studio-960.webp 960w, /images/hero-studio-1600.webp 1600w" sizes="(max-width: 820px) calc(100vw - 36px), (max-width: 1240px) 46vw, 555px" type="image/webp" /><img src="/images/hero-studio-960.webp" alt="Светлая студия для уроков грузинского языка в Батуми" width="1600" height="1067" fetchPriority="high" decoding="async" /></picture>
